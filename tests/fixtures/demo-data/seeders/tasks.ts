...
export async function seedTasks(ctx: SeederContext) {
  ...
  const tasksData = [
    ...
    // ==========================================================
    // MAT-DEMO-001 - Onboarding Stage Tasks (Stage 1 - Completed)
    // ==========================================================
    {
      id: DEMO_IDS.tasks.task43,
      firmId: DEMO_IDS.firm,
      matterId: DEMO_IDS.matters.conveyancing,
      title: "Record client instruction",
      description:
        "Document the client's instructions including property details, purchase price, and timescales. Property: 15 Willow Lane, Richmond. Price: £850,000. Target completion: 4-6 weeks.",
      status: "completed" as const,
      priority: "high" as const,
      assigneeId: DEMO_IDS.users.associate,
      createdById: DEMO_IDS.users.associate,
      dueDate: new Date(now.getTime() - 13 * 86400000),
      completedAt: new Date(now.getTime() - 13 * 86400000),
      createdAt: new Date(now.getTime() - 14 * 86400000),
      updatedAt: new Date(now.getTime() - 13 * 86400000),
      matterStageId: DEMO_IDS.matterStages.ms1_1, // Onboarding stage
      source: "workflow" as const,
      isMandatory: true,
      requiresEvidence: true,
      requiresApproval: false,
    ...
    {
      id: DEMO_IDS.tasks.task44,
      firmId: DEMO_IDS.firm,
      matterId: DEMO_IDS.matters.conveyancing,
      title: "Issue client care letter",
      description:
        "Send engagement letter with terms of business, costs estimate (£1,850 + VAT + disbursements), and scope of retainer for residential purchase.",
      status: "completed" as const,
      priority: "high" as const,
      assigneeId: DEMO_IDS.users.associate,
      createdById: DEMO_IDS.users.associate,
    ...
    {
      id: DEMO_IDS.tasks.task45,
      firmId: DEMO_IDS.firm,
      matterId: DEMO_IDS.matters.conveyancing,
      title: "Complete conflict check",
      description:
        "Check for conflicts of interest against seller, estate agent, and mortgage lender. Seller: Mr & Mrs Davidson. Agent: Savills Richmond. Lender: Nationwide.",
      status: "completed" as const,
      priority: "high" as const,
      assigneeId: DEMO_IDS.users.associate,
      createdById: DEMO_IDS.users.associate,
      ...
      approvalStatus: "approved",
      approvedById: DEMO_IDS.users.partner,
      approvedAt: new Date(now.getTime() - 13 * 86400000),
    },
    // ==========================================================
    // MAT-DEMO-001 - AML Stage Tasks (Stage 2 - Completed)
    // ==========================================================
    {
      id: DEMO_IDS.tasks.task46,
      firmId: DEMO_IDS.firm,
      matterId: DEMO_IDS.matters.conveyancing,
      title: "Verify client identity",
      description:
        "Obtain and verify photographic ID (passport/driving licence). Client provided valid UK passport - Margaret Thompson, DOB 15/03/1975. Verified against original.",
      status: "completed" as const,
      priority: "high" as const,
      assigneeId: DEMO_IDS.users.paralegal1,
      createdById: DEMO_IDS.users.associate,
      dueDate: new Date(now.getTime() - 11 * 86400000),
      completedAt: new Date(now.getTime() - 11 * 86400000),
      createdAt: new Date(now.getTime() - 12 * 86400000),
      updatedAt: new Date(now.getTime() - 11 * 86400000),
      matterStageId: DEMO_IDS.matterStages.ms1_2, // AML stage
      source: "workflow" as const,
      isMandatory: true,
      requiresEvidence: true,
      requiresApproval: false,
    ...
    {
      id: DEMO_IDS.tasks.task47,
      firmId: DEMO_IDS.firm,
      matterId: DEMO_IDS.matters.conveyancing,
      title: "Verify source of funds",
      description:
        "Obtain evidence of source of deposit (£85,000) and completion funds. Source: savings from employment as Senior Marketing Manager at Unilever. Bank statements provided showing gradual accumulation.",
      status: "completed" as const,
      priority: "high" as const,
      assigneeId: DEMO_IDS.users.paralegal1,
      createdById: DEMO_IDS.users.associate,
    ...
    {
      id: DEMO_IDS.tasks.task48,
      firmId: DEMO_IDS.firm,
      matterId: DEMO_IDS.matters.conveyancing,
      title: "Complete AML risk assessment",
      description:
        "Assess client and transaction risk level. Result: LOW RISK. UK national, employed professional, source of funds verified, no adverse PEP/sanctions checks.",
      status: "completed" as const,
      priority: "high" as const,
      assigneeId: DEMO_IDS.users.associate,
      createdById: DEMO_IDS.users.associate,
